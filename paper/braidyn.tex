...
day-gap ($<0.04$ AUC over two weeks). Cortex-wide behavioral representations are thus conserved
across individuals \emph{and} sessions as a general principle. All data are open; features are
...
alike. This is the first cross-animal decoding result on this resource; the descriptor
...
extension. Features are linear evoked responses; nonlinear temporal models may raise absolute
accuracy but the conservation and stability conclusions---driven by the LOMO-vs-within and
across-vs-same-block comparisons, not absolute AUC---should be robust.
