...
Related work is discussed in Appendix~\ref{app:related}.
...
personal decoder aging more in 73\% of pairs; the per-event breakdown is in Table~\ref{tab:asym}, Appendix~\ref{app:perevent}.
...
finding is that the personal decoder ages faster. Appendix~\ref{app:results} gives the inclusion-rule
sweep and the decomposition of the trial-split behaviour on this cohort.
...
Section~\ref{sec:protocol} of the appendix reports what the validation protocol is worth: a
