...
small single-subject sample \citep{peterson2021}. Our question differs in two ways. Primarily, prior
work measures accuracy or transfer at a fixed time, while we look at how that accuracy changes over
days, to see whether pooled decoders age more slowly. Further, we keep the training-set size fixed
with the count-matched control, hence being able to delegate the relevant overfitting not to limited
data but to idiosyncratic features that cause drift.
