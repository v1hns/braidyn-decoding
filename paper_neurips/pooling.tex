...
($p = 5 \times 10^{-5}$, 73 of 100 mouse--target pairs), carried by reward and lick; tone is marginal
and lever pull null. At matched training-event count a decoder from a single other mouse still ages
less, so this is not a data-volume effect but a consequence of not overfitting the subject's
drift-prone idiosyncrasies; it survives a 1-D CNN and a GRU as well. One caveat is load-bearing:
