...
by $+0.024$ and a decoder from one other mouse by $+0.013$. The self-minus-one gap is $+0.011$
$[0.001, 0.022]$, close to the $+0.010$ measured on BraiDyn-BC, though on 23 animals it is marginal
by the sign-flip test ($p = 0.054$).
